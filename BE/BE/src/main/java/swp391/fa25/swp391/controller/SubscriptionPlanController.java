...
public class SubscriptionPlanController {
    ...
    public ResponseEntity<?> updateSubscriptionPlan(@PathVariable Integer id, @Valid @RequestBody SubscriptionPlanRequest request) {
        try {
            // 1. Tìm kiếm Entity hiện có
            SubscriptionPlan existingPlan = subscriptionPlanService.findById(id);

            // 2. Cập nhật Entity từ Request DTO
            updateEntityFromRequest(existingPlan, request);

            // 3. Lưu lại và trả về Response DTO
